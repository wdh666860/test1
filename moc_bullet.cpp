...
struct qt_meta_stringdata_Bullet2_t {
    QByteArrayData data[3];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Bullet2_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Bullet2_t qt_meta_stringdata_Bullet2 = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Bullet2"
QT_MOC_LITERAL(1, 8, 9), // "hitTarget"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "Bullet2\0hitTarget\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Bullet2[] = {
...
QT_INIT_METAOBJECT const QMetaObject Bullet2::staticMetaObject = { {
    QMetaObject::SuperData::link<Bullet::staticMetaObject>(),
    qt_meta_stringdata_Bullet2.data,
    qt_meta_data_Bullet2,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_Bullet2.stringdata0))
        return static_cast<void*>(this);
